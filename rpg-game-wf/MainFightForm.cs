    ...
    public partial class MainFightForm : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            if (StoreInfo.isPlayer1Turn)
            {
                ...
                else if (StoreInfo.score == 2)
                {
                    damage = StoreInfo.Player1.AttackPower + 50;
                }
                else if (StoreInfo.score == 1)
                {
                    damage = StoreInfo.Player1.AttackPower;
                }
                else
                {
                    damage = StoreInfo.Player1.AttackPower - 50;
            ...
            else
            {
                ...
                {
                    damage = StoreInfo.Player2.AttackPower + 50;
                }
                else if (StoreInfo.score == 1)
                {
                    damage = StoreInfo.Player2.AttackPower;
                }
                else
                {
                    damage = StoreInfo.Player2.AttackPower - 50;
